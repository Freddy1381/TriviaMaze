...
public class R {
	...
	public static class ImageIcons {
		...
		public static final ImageIcon EMPTY_ROOM = new ImageIcon(R.class.getResource("/images/EmptyRoom.png"));
		public static final ImageIcon EXIT_ROOM = new ImageIcon(R.class.getResource("/images/ExitRoom.png"));
		public static final ImageIcon LOCKED_DOOR_V = new ImageIcon(R.class.getResource("/images/LockedDoorVertical.png"));
		public static final ImageIcon LOCKED_ROOM = new ImageIcon(R.class.getResource("/images/LockedRoom.png"));
		public static final ImageIcon START_ROOM = new ImageIcon(R.class.getResource("/images/StartRoom.png"));
		public static final ImageIcon UNLOCK_DOOR_V = new ImageIcon(R.class.getResource("/images/UnlockedDoorVertical.png"));
		public static final ImageIcon LOCKED_DOOR_H = new ImageIcon(R.class.getResource("/images/LockedDoorHorizontal.png"));
		public static final ImageIcon UNLOCK_DOOR_H = new ImageIcon(R.class.getResource("/images/UnlockedDoorHorizontal.png"));
